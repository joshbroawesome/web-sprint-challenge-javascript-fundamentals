...
*/
const displayNames = [];
zooAnimals.forEach((item, i, arr) => {
  displayNames.push([arr[i].animal_name, arr[i].scientific_name])
});
...
lowPopulationAnimals.push(zooAnimals.filter((item, i, arr)=> {
...
populationTotal = population.reduce(
